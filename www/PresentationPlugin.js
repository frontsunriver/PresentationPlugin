...
Object.defineProperty(NavigatorPresentation.prototype, "sendHtmlContent", {
    get: function() {
        return navigatorPresentationSendHtmlContent;
    }
});

var navigatorPresentationSendHtmlContent = function(data) {
    var successCallback = function(result) {
        console.log("navigatorPresentationSendHtmlContent success result...", result)
    };
